...
module.exports = {
  ...
  dependencies: {
    ...
    ja: "{{=e.params.property}}がある場合、{{#def.n}}は{{=e.params.deps}}を指定しなければいけません",
  ...
  format: {
    ...
    ja: '"{{=e.params.format}}"形式に合わせる必要があります',
  ...
  maxProperties: {
    ...
    ja: "{{#def.n}}は{{=n}}個以上のプロパティを定義してはいけません",
  ...
  minProperties: {
    ...
    ja: "{{#def.n}}は{{=n}}個以下のプロパティを定義してはいけません",
  ...
  multipleOf: {
    ...
    ja: "{{=e.params.multipleOf}}の倍数でなければいけません",
  ...
  oneOf: {
    ...
    ja: '"oneOf"のスキーマと完全に一致しなくてはいけません',
  ...
  pattern: {
    ...
    ja: '"{{=e.params.pattern}}"のパターンと一致しなければいけません',
  ...
  required: {
    ...
    ja: "必要なプロパティ{{=e.params.missingProperty}}がなければいけません",
  ...
  unevaluatedItems: {
    ...
    ja: "{{#def.n}}は要素の数が{{=n}}個以上ではいけません {{#def.mPlural}}",
  ...
  uniqueItems: {
    ...
    ja: "重複するアイテムがあってはいけません（{{=e.params.j}}と{{=e.params.i}}は同じです）",
  ...
  patternRequired: {
    ...
    ja: '"{{=e.params.missingPattern}}"に一致するプロパティ名が必要です',
  ...
  if: {
    ...
    ja: '"{{=e.params.failingKeyword}}"に一致しなければいけません',
  ...
  discriminator: {
    ...
    tag: {
      ...
      ja: 'タグ "{{=e.params.tag}}" は文字列でなければいけません',
    ...
    mapping: {
      ...
      ja: 'タグ "{{=e.params.tag}}" はoneOfでなければいけません',

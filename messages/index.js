...
module.exports = {
  // supported locales
  _locales: ['en', 'ar', 'cz', 'de', 'es', 'fr', 'hu', 'it', 'ja', 'nb', 'nl', 'pl', 'pt-BR', 'ru', 'sk', 'sv', 'zh'],
  ...
  additionalItems: {
    ...
    nl: '{{#def.n}}zou niet meer dan {{=n}} item{{#def.mPlural}} moeten hebben}}',
  ...
  additionalProperties: {
    ...
    nl: 'zou geen extra eigenschappen moeten hebben',
  ...
  anyOf: {
    ...
    nl: 'zou met een schema in "anyOf" moeten overeenkomen',
  ...
  dependencies: {
    ...
    nl: '{{#def.n}}zou eigenschap{{#def.propPlural}} {{=e.params.deps}} moeten hebben wanneer eigenschap {{=e.params.property}} aanwezig is',
  ...
  enum: {
    ...
    nl: 'zou gelijk moeten zijn aan één van de voorgedefinieerde waardes',
  ...
  format: {
    ...
    nl: 'zou moeten overeenkomen met dit formaat: "{{=e.params.format}}"',
  ...
  minItems: {
    ...
    nl: '{{#def.n}}zou niet minder dan {{=n}} item{{#def.mPlural}} moeten hebben',
  ...
  maxLength: {
    ...
    nl: '{{#def.n}}zou niet langer dan {{=n}} karakter{{#def.mPlural}} moeten zijn',
  ...
  minLength: {
    ...
    nl: '{{#def.n}}zou niet korter dan {{=n}} karakter{{#def.mPlural}} moeten zijn',
  ...
  maxProperties: {
    ...
    nl: '{{#def.n}}zou niet meer dan {{=n}} eigenschap{{#def.propPlural}} moeten hebben',
  ...
  minProperties: {
    ...
    nl: '{{#def.n}}zou niet minder dan {{=n}} eigenschap{{#def.propPlural}} moeten hebben',
  ...
  multipleOf: {
    ...
    nl: 'zou een veelvoud moeten zijn van {{=e.params.multipleOf}}',
  ...
  not: {
    ...
    nl: 'zou niet moeten overeenkomen met een schema in "not"',
  ...
  oneOf: {
    ...
    nl: 'zou maar met één schema in "oneOf" moeten overeenkomen',
  ...
  pattern: {
    ...
    nl: 'zou aan dit patroon moeten voldoen "{{=e.params.pattern}}"',
  ...
  required: {
    ...
    nl: 'zou de verplichte eigenschap {{=e.params.missingProperty}} moeten hebben',
  ...
  type: {
    ...
    nl: '{{#def.t}}zou een {{? t == "number" }}nummer{{?? t == "integer"}}geheel getal{{?? t == "string"}}tekenreeks{{?? t == "boolean"}}ja of nee waarde {{?}} ({{{=t}}) moeten zijn',
  ...
  uniqueItems: {
    ...
    nl: 'zou geen dubbele items moeten bevatten (items ## {{=e.params.j}} en {{=e.params.i}} zijn gelijk)',
  ...
  custom: {
    ...
    nl: 'zou sleutelwoord validatie "{{=e.keyword}}" moeten doorstaan',
  ...
  patternRequired: {
    ...
    nl: 'zou een eigenschap moeten hebben met het volgende patroon "{{=e.params.missingPattern}}"',
  ...
  switch: {
    ...
    nl: 'zou "switch" sleutelwoord validatie moeten doorstaan, geval {{=e.params.caseIndex}} gaat verkeerd',
  ...
  const: {
    ...
    nl: 'zou gelijk moeten zijn aan de constante',
  ...
  contains: {
    ...
    nl: 'zou een geldig item moeten bevatten',
  ...
  formatExclusiveMaximum: {
    ...
    nl: 'formatExclusiveMaximum zou een boolean moeten zijn',
  ...
  formatExclusiveMinimum: {
    ...
    nl: 'formatExclusiveMinimum zou een boolean moeten zijn',
  ...
  if: {
    ...
    nl: 'zou met "{{=e.params.failingKeyword}}" schema moeten overeenkomen',

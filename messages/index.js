...
module.exports = {
  ...
  _defaultMessage: {
    ...
    ka: 'უნდა გადმოსცეთ ვალიდური "{{=e.keyword}}"',
  ...
  "false schema": {
    ...
    ka: "ლოგიკური ტიპის სქემა არის false",
  ...
  additionalProperties: {
    ...
    ja: "追加してはいけない",
    ka: "არ უნდა შეიცავდეს დამატებით ველებს",
  ...
  anyOf: {
    ...
    ka: 'უნდა შეესაბამებოდეს ერთერთს სქემაში "anyOf"',
  ...
  dependencies: {
    ...
    ka: "{{#def.n}}უნდა შეიცავდეს ველ{{#def.propPlural}} {{=e.params.deps}} როცა ველის მნიშვნელობა {{=e.params.property}} არსებობს",
  ...
  enum: {
    ...
    ka: "უნდა შეესაბამებოდეს ერთერთ დასაშვებ მნიშვნელობას",
  ...
  format: {
    ...
    ka: 'უნდა შეესაბამებოდეს ფორმატს "{{=e.params.format}}"',
  ...
  minItems: {
    ...
    ka: "{{#def.n}}არ უნდა შეიცავდეს {{=n}}-ზე ნაკლებ ელემენტ{{#def.mPlural}}",
  ...
  maxLength: {
    ...
    ka: "{{#def.n}}არ უნდა შეიცავდეს {{=n}}-ზე მეტ სიმბოლო{{#def.mPlural}}",
  ...
  minLength: {
    ...
    ka: "{{#def.n}}არ უნდა შეიცავდეს {{=n}}-ზე ნაკლებ სიმბოლო{{#def.mPlural}}",
  ...
  minProperties: {
    ...
    ka: "{{#def.n}}არ უნდა შეიცავდეს {{=n}}-ზე ნაკლებ ველ{{#def.propPlural}}",
  ...
  multipleOf: {
    ...
    ka: "უნდა შეიცავდეს {{=e.params.multipleOf}}-ს ჯერადს",
  ...
  not: {
    ...
    ka: 'არ უნდა იყოს ვალიდური, სქემა "not"-ის მიხედვით',
  ...
  oneOf: {
    ...
    ka: 'უნდა შეესაბამებოდეს ზუსტად ერთს, სქემაში "oneOf"',
  ...
  pattern: {
    ...
    ka: 'უნდა შეესაბამებოდეს შაბლონს "{{=e.params.pattern}}"',
  ...
  required: {
    ...
    ka: "უნდა შეიცავდეს აუცილებელ ველს {{=e.params.missingProperty}}",
  ...
  unevaluatedProperties: {
    ...
    ka: "არ უნდა შეიცავდეს შეუმოწმებელ ველს",
  ...
  uniqueItems: {
    ...
    ka: "არ უნდა შეიცავდეს დუბლირებულ მნიშვნელობებს (ელემენტები ## {{=e.params.j}} და {{=e.params.i}} არიან იდენტურები)",
  ...
  patternRequired: {
    ...
    ka: 'ველი რომელიც შეესაბამება შაბლონს "{{=e.params.missingPattern}}" სავალდებულოა',
  ...
  const: {
    ...
    ka: "უნდა შეესაბამებოდეს მუდმივას მნიშვნელობას",
    ko: "상수와 같아야합니다",
  ...
  contains: {
    ...
    ka: "უნდა შეიცავდეს ვალიდურ ელემენტს",
  ...
  if: {
    ...
    ka: 'უნდა შეესაბამებოდეს სქემას "{{=e.params.failingKeyword}}"',
  ...
  discriminator: {
    ...
    mapping: {
      ...
      ka: 'იარლიყის მნიშვნელობა "{{=e.params.tag}}" უნდა იყოს oneOf სქემაში',

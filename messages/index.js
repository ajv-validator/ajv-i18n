...
module.exports = {
  ...
  "false schema": {
    ...
    fi: "boolean skeema on virheellinen",
  ...
  enum: {
    ...
    fi: "täytyy vastata yhtä ennalta määritetyistä arvoista",
  ...
  oneOf: {
    ...
    fi: 'täytyy vastata "oneOf" -kohdassa määriteltyä skeemaa',
  ...
  pattern: {
    ...
    fi: 'täytyy vastata mallia "{{=e.params.pattern}}"',
  ...
  required: {
    ...
    fi: "{{=e.params.missingProperty}} vaaditaan",
  ...
  patternRequired: {
    ...
    fi: 'ominaisuuden on vastattava muotoa "{{=e.params.missingPattern}}"',

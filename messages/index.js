...
module.exports = {
  // supported locales
  _locales: ['en', 'ar', 'cz', 'de', 'es', 'fr', 'hu', 'it', 'ja', 'nb', 'nl', 'pl', 'pt-BR', 'ru', 'sk', 'sv', 'th', 'zh', 'zh-TW'],
  ...
  formatExclusiveMaximum: {
    ...
    de: 'formatExclusiveMaximum sollte ein boolescher Wert sein',
  ...
  formatExclusiveMinimum: {
    ...
    de: 'formatExclusiveMinimum sollte ein boolescher Wert sein',

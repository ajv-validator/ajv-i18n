...
module.exports = {
  // supported locales
  _locales: ['en', 'cz', 'de', 'es', 'fr', 'hu', 'it', 'ja', 'nb', 'pl', 'pt-BR', 'ru', 'sk', 'sv', 'zh'],
  ...
  patternGroups: {
    ...
    nb: '{{#def.n}}må ha {{=e.params.reason}} {{=n}} egenskap{{#def.mPlural}} som samsvarer med mønsteret "{{=e.params.pattern}}"',

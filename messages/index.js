...
module.exports = {
  ...
  additionalProperties: {
    ...
    th: "ไม่ควรมี property นอกเหนีอจากที่กำหนดไว้",
    zh: "不允许有额外的属性",
    "zh-TW": "不可以有額外的屬性",
  },
  anyOf: {
    ...
    th: 'ควรตรงกับบางอย่างที่กำหนดไว้ใน "anyOf"',
  ...
  dependencies: {
    ...
    th:
      "{{#def.n}}เมื่อมี property {{=e.params.property}} แล้ว ก็ควรมี property {{=e.params.deps}} ด้วย",
  ...
  enum: {
    ...
    th: "ควรตรงกับหนึ่งในค่าที่กำหนดไว้",
    zh: "应当是预设定的枚举值之一",
    "zh-TW": "應該要在預設的值之中",
  },
  format: {
    ...
    th: 'รูปแบบควรตรงกับ "{{=e.params.format}}"',

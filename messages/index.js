...
module.exports = {
  ...
  _defaultMessage: {
    ...
    ja: 'キーワード"{{=e.keyword}}"のバリーデーションを合格しなければなりません',
  ...
  anyOf: {
    ...
    ja: '"anyOf"に含まれるスキーマとマッチしなければなりません',
  ...
  dependencies: {
    ...
    ja: "{{#def.n}}はプロパティ{{=e.params.property}}を持つ場合、プロパティ{{=e.params.deps}}を持たなければなりません",
  ...
  maxProperties: {
    ...
    ja: "{{#def.n}}のプロパティは{{=n}}個以上であってはなりません",
  ...
  minProperties: {
    ...
    ja: "{{#def.n}}のプロパティは{{=n}}個以下であってはなりません",
  ...
  multipleOf: {
    ...
    ja: "{{=e.params.multipleOf}}の倍数でなければなりません",
  ...
  not: {
    ...
    ja: '"not"に含まれるスキーマに従って有効であってはなりません',
  ...
  oneOf: {
    ...
    ja: '"oneOf"に含まれる1つのスキーマとマッチしなければなりません',
  ...
  required: {
    ...
    ja: "プロパティ{{=e.params.missingProperty}}を持たなければなりません",
  ...
  uniqueItems: {
    ...
    ja: "重複する要素を含んではなりません（{{=e.params.j}}と{{=e.params.i}}は同じです）",
  ...
  patternRequired: {
    ...
    ja: 'プロパティはパターン"{{=e.params.missingPattern}}"と一致しなければなりません',
  ...
  if: {
    ...
    ja: '"{{=e.params.failingKeyword}}"スキーマとマッチしなければなりません',
  ...
  discriminator: {
    ...
    tag: {
      ...
      ja: 'タグ"{{=e.params.tag}}"は文字列でなければなりません',
    ...
    mapping: {
      ...
      ja: 'タグの値"{{=e.params.tag}}"はoneOfに含まれていなければなりません',

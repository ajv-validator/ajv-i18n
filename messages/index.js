...
module.exports = {
  ...
  enum: {
    ...
    ka: "უნდა უდრიდეს ერთერთ დასაშვებ მნიშვნელობას",
  ...
  maxLength: {
    ...
    ka: "{{#def.n}}არ უნდა შეიცავდეს {{=n}}-ზე გრძელ სიმბოლო{{#def.mPlural}}",
  ...
  minLength: {
    ...
    ka: "{{#def.n}}არ უნდა შეიცავდეს {{=n}}-ზე მოკლე სიმბოლო{{#def.mPlural}}",
  ...
  pattern: {
    ...
    ka: 'უნდა შეესაბამებოდეს ნიმუშს "{{=e.params.pattern}}"',
  ...
  uniqueItems: {
    ...
    ka: "არ უნდა შეიცავდეს გაორმაგებულ მნიშვნელობას (ველები ## {{=e.params.j}} და {{=e.params.i}} არიან იდენტურები)",
  ...
  propertyNames: {
    ...
    ka: "ველის სახელი არის არავალიდური",
    ko: "속성명이 올바르지 않습니다",
  ...
  const: {
    ...
    ka: "უნდა უდრიდეს მუდმივას მნიშვნელობას",
    ko: "상수와 같아야합니다",
  ...
  if: {
    ...
    ka: 'უნდა შეესაბამებოდეს "{{=e.params.failingKeyword}}" სქემას',
  ...
  discriminator: {
    ...
    mapping: {
      ...
      ka: 'იარლიყის მნიშვნელობები "{{=e.params.tag}}" უნდა იყოს oneOf სქემაში',

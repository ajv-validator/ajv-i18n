...
module.exports = {
  ...
  _defaultMessage: {
    ...
    mn: '"{{=e.keyword}}"шалгалтын давах ёстой',
  ...
  properties: {
    ...
    additional: {
      ...
      mn: "Зөвшөөрөгдөөгүй талбар байна",
    ...
    missing: {
      ...
      mn: "{{=e.params.missingProperty}} талбар заавал байх ёстой",
  ...
  discriminator: {
    ...
    tag: {
      ...
      mn: '"{{=e.params.tag}}"таг нь тест байх ёстой',
    ...
    mapping: {
      ...
      mn: '"{{=e.params.tag}}"таг-н утга нь mapping байх ёстой.',
  ...
  enum: {
    ...
    mn: "Зөвшөөрөгдсөн утгуудын аль нэг байх ёстой",
  ...
  union: {
    ...
    mn: '"union" schema-тай таарч байх ёстой',
